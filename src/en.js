...
export const PRODUCT_BASIC_DESCRIPTION = 'A free account for a single user.';
export const PRODUCT_BASIC_NAME = 'Basic';
export const PRODUCT_HEALTH_STANDARD_DESCRIPTION = 'Standard account for a small group.';
export const PRODUCT_HEALTH_STANDARD_NAME = 'Standard';
export const PRODUCT_HEALTH_STANDARD_BULLET_1 = 'Health checks every hour.';
export const PRODUCT_HEALTH_STANDARD_BULLET_2 = '10 page limit.';
export const PRODUCT_HEALTH_STANDARD_BULLET_3 = '5 user limit.';
export const PRODUCT_HEALTH_STANDARD_BULLET_4 = 'Online reporting.';
export const PRODUCT_HEALTH_STANDARD_BULLET_5 = 'Email notifications.';
export const PRODUCT_HEALTH_ADVANCED_DESCRIPTION = 'Advanced account for a larger group and number of pages.';
export const PRODUCT_HEALTH_ADVANCED_NAME = 'Advanced';
export const PRODUCT_HEALTH_ADVANCED_BULLET_1 = 'Health checks every half hour.';
export const PRODUCT_HEALTH_ADVANCED_BULLET_2 = '10 page limit.';
export const PRODUCT_HEALTH_ADVANCED_BULLET_3 = '10 user limit.';
export const PRODUCT_HEALTH_ADVANCED_BULLET_4 = 'Online reporting.';
export const PRODUCT_HEALTH_ADVANCED_BULLET_5 = 'Email notifications.';
export const PRODUCT_HEALTH_ADVANCED_BULLET_6 = 'Slack and PagerDuty alerting.';
export const PRODUCT_HEALTH_ENTERPRISE_DESCRIPTION = 'Enterprise account for a large group, number of pages and higher frequency of checks.';
export const PRODUCT_HEALTH_ENTERPRISE_NAME = 'Enterprise';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_1 = 'Health checks every fifteen minutes.';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_2 = '25 page limit.';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_3 = '25 user limit.';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_4 = 'Online reporting.';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_5 = 'Email notifications.';
export const PRODUCT_HEALTH_ENTERPRISE_BULLET_6 = 'Slack and PagerDuty alerting.';
