...
export const PRODUCT_0_NAME = 'Basic Performance Monitoring';
...
export const PRODUCT_6_NAME = 'Lighthouse Check';
export const PRODUCT_6_BULLET_1 = '20 URLs.';
export const PRODUCT_6_BULLET_2 = '20 runs per URL, per day.';
export const PRODUCT_6_BULLET_3 = 'Run audits from "US East", "US West", and "UK West" (London) regions.';
export const PRODUCT_6_BULLET_4 = 'Access to a variety of workflow integrations.';
export const PRODUCT_6_BULLET_5 = 'Online reporting.';
